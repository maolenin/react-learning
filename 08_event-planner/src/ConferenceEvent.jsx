...
//  const venueTotalCost = calculateTotalCost("venue"); //added just in case, I don't remeber this was req  uested to add
  ...
  const handleMealSelection = (index) => {
    ...
    if (item.selected && item.type === "mealForPeople") {
      // ensure numberOfPeople is set before togglin selection
        ...
        <div className="left_navbar">
          ...
          <div className="main_container">
            ...
            <div id="meals" className="venue_container container_main">
                ...
                <label htlmFor="numberOfPeople"> <h3>Number of People:</h3>  </label>
